...
Introduction: Simple Introduction To RSS
...
L<XML::RSS::Tools::example-1> - simple example

=item *

L<XML::RSS::Tools::example-2> - complete example

=item *

L<XML::RSS::Tools::example-3> - concise example

=item *

L<XML::RSS::Tools::example-4> - single stylesheet example with no normalisation

=item *

L<XML::RSS::Tools::example-5> - a complete RSS client mini-application

=item *

L<XML::RSS::Tools::rss_with_xslt> - an article from The Perl Review
